...
`MRGEI_Gam3seo_3to1()`  
  Run the standard, continuous-environment and binary-environment MERLIN MCMC kernel, with the relevant parameters adjusted according to the specific analysis setting.
...
#### Value
A list containing `Beta1.hat`, `Beta1.se`, `Beta1.pval`, `Beta4.hat`, `Beta4.se`, and `Beta4.pval`.
...
### **`MRGEI_Gam3seo_3to1()`**
Run the binary-environment MERLIN MCMC kernel for an unbalanced sample distribution.
