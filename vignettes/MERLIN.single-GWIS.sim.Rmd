...
For this toy example, SNPs are independent and we use $P < 0.01$ as the
...
$\widehat{\Gamma}_3$ and its standard error are omitted. MERLIN-MO first
obtains an MR-Egger estimate of the average causal effect $\beta_1$. This
estimate is then held fixed while $\beta_4$ is estimated using the exposure
GWAS, exposure GWIS, and outcome GWAS summary statistics. Accordingly,
$\beta_4$ is the primary estimand of this analysis.
