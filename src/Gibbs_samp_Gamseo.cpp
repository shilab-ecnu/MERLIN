...
ObjGibbs_Gamseo MRGibbs_Gamseo(arma::vec &gammah1, arma::vec &gammah3, arma::vec&Gammah1, 
                          arma::mat &S1, arma::mat &S2, arma::mat &S3,
                          arma::mat &L2, arma::mat &U2, arma::mat &R, double &rho,
...
List MRGEI_Gamseo(arma::vec &gammah1,arma::vec &gammah3, arma::vec &Gammah1, arma::vec &se1, arma::vec &se2, arma::vec &se3, arma::mat &R, double &rho, int maxIter, int burnin, int thin)
{
    ...
    ObjGibbs_Gamseo obj = MRGibbs_Gamseo( gammah1, gammah3, Gammah1, S1, S2, S3, L2, U2, R, rho, maxIter, burnin, thin);
