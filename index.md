...
and Genome-Wide Interaction Studies (GWIS). The simulation and real data
analyses code for reproduction can be found here:
[REPRODUCTION](https://github.com/ydong-work/MERLIN_analysis/tree/main).
