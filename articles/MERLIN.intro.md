# Part 1: Introduction and Data Requirements
...
= $`1`$ and Female = $`-1`$, and that the allele directions are
perfectly aligned between the two datasets:
...
If you do not have these files, a pre-formatted reference panel and LD
block file for European populations are provided alongside our package
data at:
<https://figshare.com/articles/dataset/Data_for_MERLIN/29910116>.
